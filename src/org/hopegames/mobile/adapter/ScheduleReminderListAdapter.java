...
public class ScheduleReminderListAdapter extends ArrayAdapter<org.hopegames.mobile.model.Activity> {

	public static final String TAG = ScheduleReminderListAdapter.class.getSimpleName();

	private final Context ctx;
	private final ArrayList<org.hopegames.mobile.model.Activity> activityList;
	private SharedPreferences prefs;
	
	public ScheduleReminderListAdapter(Context context, ArrayList<org.hopegames.mobile.model.Activity> activityList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    org.hopegames.mobile.model.Activity a = activityList.get(position);
