...
public class LoginMessageUsersTask extends AsyncTask<Payload, Object, Payload> {
	...
	public LoginMessageUsersTask(Context c) {
		this.ctx = c;
	...
	protected Payload doInBackground(Payload... params) {
		...
		try {
			...
			paramsPost.add(new BasicNameValuePair("limitnum", "50"));
			paramsPost.add(new BasicNameValuePair("moodlewssettingfilter", "true"));
			paramsPost.add(new BasicNameValuePair("newestfirst","1"));
			paramsPost.add(new BasicNameValuePair("read", "0"));
			paramsPost.add(new BasicNameValuePair("type", "conversations"));
			paramsPost.add(new BasicNameValuePair("useridfrom", u.getSwipe_0()));
			paramsPost.add(new BasicNameValuePair("useridto",""+u.getMsgUserId()));
